import { Body, Controller, Get, InternalServerErrorException, Logger, Param, Post, Query, Req, UseGuards } from '@nestjs/common';
...
export class PostController {
  ...
  async getAllPost(
    ...
    const Posts: GetPosts[] = await this.postService.getAllPost(token);
